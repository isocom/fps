...
public class ElzabOmega2 implements FiscalPrinter {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (args.length != 0) {
            fp = ElzabOmega2.getFiscalPrinter(args[0]);
        } else {
            fp = ElzabOmega2.getFiscalPrinter("COM1");
        }
    ...
    public static FiscalPrinter getFiscalPrinter(String comPortName) {
        return new ElzabOmega2(comPortName);
    }
    private String comPortName;
    private SerialPort serialPort = null;

    private ElzabOmega2(String comPortName) {
    ...
    public void print(Slip slip) throws FiscalPrinterException {
        try {
            ...
            sendToPrinter(new byte[]{0x1B, 0x21}); // rozpoczęscie paragonu
            waitForAck();
