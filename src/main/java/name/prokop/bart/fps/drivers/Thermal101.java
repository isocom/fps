 ...
 */
public class Thermal101 implements FiscalPrinter {
    ...
    public static void main(String[] args) {
        ...
        if (args.length != 0) {
            fp = Thermal101.getFiscalPrinter(args[0]);
        } else {
            fp = Thermal101.getFiscalPrinter("COM1");
        }
    ...
    public static FiscalPrinter getFiscalPrinter(String comPortName) {
        return new Thermal101(comPortName);
    }
    /**
     ...
     * drukarka fiskalna.
     */
    private Thermal101(String comPortName) {
